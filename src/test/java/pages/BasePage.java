...
public class BasePage {
    ...
    String app_package_name = "com.mokapos.android.staging:id/";

    public BasePage(WebDriver driver){
        this.driver = driver;
    }

    protected void waitForVisibilityOf(By locator){ //wait for visibility of an element
        WebDriverWait wait = new WebDriverWait(driver,30);
        wait.until(ExpectedConditions.visibilityOfElementLocated(locator));
    }

    protected void waitForClickabilityOf(By locator){ //wait for click-enability of an element
        WebDriverWait wait = new WebDriverWait(driver,30);
